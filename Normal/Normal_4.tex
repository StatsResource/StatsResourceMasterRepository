...
\titlepage
\end{frame}
<<<<<<< HEAD:Exponential/Exponential_Distribution.tex
...
\bigskip \textbf{1. Complement rule}\begin{itemize}  \item Common to all continuous random variables
...
%---------------------------------------------%
\end{document}
>>>>>>> 83d092f0fa9a6b24fc889477647398d100cecefe:Normal/Normal_4.tex
