...
\[ S.E.(\bar{x}-\bar{y}) = \sqrt{\frac{2.743}{17} + \frac{2.985}{17}} = \sqrt{0.33698} = 0.5805\]
...
\subsection*{Small Aggregate Samples}
...
\subsection*{Small Aggregate Samples - Worked Example}
