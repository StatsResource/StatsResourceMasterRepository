...
\begin{itemize}
\item[(i)] What is the probability that a randomly chosen person from the sample is a
computer science student?
\item[(ii)] What is the probability that a randomly chosen person from the sample is both female and studying statistics?
\item[(iii)] What is the probability that a randomly chosen person from the sample is male?
\item  Given that a student studies statistics, what is the probability that the student is female?
%\item[v] What is the probability that a randomly chosen person from the sample is a
%male or a statistics student?
%\item[vi] Given that the student is female, what is the probability that she is an
...
\item[ii] Determine the expected value $E(X)$.
\item[iii] Evaluate $E(X^2)$.
